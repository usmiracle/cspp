...
{
    [Test]
    [Swagger(Path = Paths.AdminBlackList, Operation = OperationType.Get, ResponseCode = 401)]
    ...
    [Swagger(Path = Paths.AdminBlackList, Operation = OperationType.Get, ResponseCode = 403)]
    ...
    [Swagger(Path = Paths.AdminBlackList, Operation = OperationType.Get, ResponseCode = 200)]
